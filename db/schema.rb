...
ActiveRecord::Schema.define(version: 20151126000517) do
  ...
  add_index "likes", ["user_id", "speech_id"], name: "index_likes_on_user_id_and_speech_id", unique: true
  ...
  add_index "speeches", ["issue_id"], name: "index_speeches_on_issue_id"
